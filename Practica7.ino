...
byte Usuario2[4]= {0xB9, 0xF3, 0x1A, 0xB3} ;    // UID de llavero leido en programa 1
...
void setup() {
  ...
  lcd.begin(16, 2);
  lcd.print("Coloca tarjeta");//Imprime el texto en la LCD
